...
!ifdef MULTIUSER_INSTALLMODEPAGE
  ...
  ${LangFileString} MULTIUSER_TEXT_INSTALLMODE_SUBTITLE "選擇要安裝 $(^NameDA) 給哪些使用者。"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_TOP "選擇只將 $(^NameDA) 安裝給自己或是安裝給所有使用者。 $(^ClickNext)"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_ALLUSERS "安裝給這台電腦的所有使用者"
  ${LangFileString} MULTIUSER_INNERTEXT_INSTALLMODE_CURRENTUSER "只安裝給自己"
!endif